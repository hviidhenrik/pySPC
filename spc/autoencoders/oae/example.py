import pandas as pd
from orthogonal_autoencoder.oae_pyspc.control_charts import ProcessMonitoring
...
SPC.fit(data=training_data, encoding_layers=[33, 33], orthogonality_regularization=1, norm="l2",
